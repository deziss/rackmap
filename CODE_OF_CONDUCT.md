...
via [GitHub Security Advisories](https://github.com/deziss/rackmap/security/advisories/new) or by opening a
private conversation with a maintainer. All complaints will be reviewed and investigated promptly and fairly.
...
2. **Warning** — a warning with consequences for continued behavior, including a period of no interaction.
